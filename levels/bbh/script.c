...
const LevelScript level_bbh_entry[] = {
    ...
    AREA(/*index*/ 1, Bbh_area_1),
        ...
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ -478, 720, -1650, /*angle*/ 0, 90, 0, /*bhvParam*/ BPARAM2(WARP_NODE_0A), /*bhv*/ bhvSpinAirborneWarp),
        WARP_NODE(/*id*/ WARP_NODE_0A,    /*destLevel*/ LEVEL_BBH,              /*destArea*/ 1, /*destNode*/ WARP_NODE_0A, /*flags*/ WARP_NO_CHECKPOINT),
        OBJECT(/*model*/ MODEL_BITDW_WARP_PIPE,   /*pos*/ -478, 880, -1650, /*angle*/ 180, 180, 0, /*bhvParam*/ 0x00000000, /*bhv*/ bhvStaticObject),
